# Generated by Django 3.2 on 2022-11-27 23:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('posts', '0001_initial'),
        ('accounts', '0002_auto_20221127_2227'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.ManyToManyField(blank=True, null=True, related_name='user_comments', to='posts.Post', verbose_name='Прокомментированные публикации'),
        ),
        migrations.AlterField(
            model_name='account',
            name='liked_posts',
